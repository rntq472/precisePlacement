...
It provides translations between inches, pixels, margin lines, data units, and proportions of the plotting space so that plot elements can easily be added relative to each other or to the figure boundaries. Alongside `par(xpd = NA)` it helps with tasks such as placing legends outside of the plotting boundaries and identifying margin lines.
