...
An overview of the package can be found on [CRAN](https://cran.r-project.org/web/packages/precisePlacement/vignettes/Overview.html) or in [vignettes/Overview.Rmd](https://github.com/rntq472/precisePlacement/blob/master/vignettes/Overview.Rmd).
