...
##' margin lines, and data units in a manner more simple than manipulating
##' par(). It helps users identify where exactly the margin lines of a plot
##' fall and to create sub-figures.
##' 
